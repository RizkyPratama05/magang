...
class TambahKolom extends Database
{
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into data_pilah_kolom (kode_data_pilah,header_kolom,nama_kolom,kode_kolom,jml_l,jml_p,jml_lp,tipe_kolom,aktif) VALUES 
                                          (:kode_data_pilah,:header_kolom,:nama_kolom,:kode_kolom,:jml_l,:jml_p,:jml_lp,:tipe_kolom,:aktif)";
