...
<header id="header">
    ...
    <span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Already registered?</span> <a
                href="index.php" class="btn btn-danger">Sign In</a> </span>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div class="well no-padding">
                    <form action="loginout.php" method="POST" id="smart-form-register" class="smart-form client-form">
                        ...
                        <fieldset>
                            ...
                            <section>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    <input type="text" maxlength="20" value="<?=@$username ?>" name="username" placeholder="Username">
                                    <b class="tooltip tooltip-bottom-right">Username wajib diisi</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    <input type="text" value="<?=@$nama ?>"  name="nama" placeholder="Nama">
                                    <b class="tooltip tooltip-bottom-right">Nama wajib diisi</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    <input type="password" name="password" placeholder="password">
                                    <b class="tooltip tooltip-bottom-right">Password wajib diisi</b> </label>
                            </section>
