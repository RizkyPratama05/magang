...
class Kategori extends Database
{
    ...
    public function ACTION_list($return=false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM ref_kategori ";
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into ref_kategori (kategori) VALUES 
                                          (:kategori)";
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update ref_kategori set kategori=:kategori
    ...
    public function ACTION_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from ref_kategori WHERE kode_kategori=:kode_kategori";
        echo $this->dbDataExecute($sql,$params['data']);
    }
