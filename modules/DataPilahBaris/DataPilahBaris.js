...
(function () {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [
            ...
            {"data": "kode_data_pilah"},{"data": "no_urut"},{"data": "kode_baris"},{"data": "nama_baris"},{"data": "aktif"},
        ],
        dom: 'Bfrtip',
        ...
        initComplete: function () {
            ...
            $('.btTop').click(function () {
                ...
                if(aksi === 'add'){
                    MyApp.$me.aksi = 'add';
                    $('#myModal').modal('show');
                    $('.modal-title').html("Tambah Data Pilah Baris");
            ...
            selectortable.on('click','.btUpdate',function () {
                ...
                $('.modal-title').html("Update Data Pilah Baris");
    ...
    $('.btSimpan').on('click', function () {
        ...
        }else if($("#form_input #kode_baris").val().trim() === "") {
            alert("Kode baris harus diisi !")
        }else{
            idForm = $('#form_input');
