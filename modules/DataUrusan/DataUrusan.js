...
(function () {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [
            ...
            {"data": "id_urusan"},{"data": "kode_urusan"},{"data": "urusan"},{"data": "satuan"},
        ],
        dom: 'Bfrtip',
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function (tpl) {
                    ...
                    for (i=0;i<resp.result.length;i++){
                        data2[i]={};data2[i].id_urusan = nama=resp.result[i].id_urusan;data2[i].kode_urusan = nama=resp.result[i].kode_urusan;data2[i].urusan = nama=resp.result[i].urusan;data2[i].satuan = nama=resp.result[i].satuan;
                    }
