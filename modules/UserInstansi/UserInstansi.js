...
(function () {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [
            ...
            },
            {
                "data": function (val, item, index) {
                    ...
                    btn2 = "<a style='padding: 2px;' href='#' class='btUpdate' data-index='" + MyApp.$me.index + "'" +
        ...
        initComplete: function () {
            ...
            selectortable.on('click','.btUpdate',function () {
                ...
                $('.modal-title').html("Update Data Instansi");
                $('#myModal').modal('show');
                index = $(this).data('index');
                dataRow = MyApp.$me.dataRow[index];
            ...
            selectortable.on('click','.btHapus',function () {
                index = $(this).data('index');
                dataRow = MyApp.$me.dataRow[index];
                konfirmasi = confirm('Apakah anda yakin ingin menghapus instansi ini?');
                if(konfirmasi){
                    delInstansi(dataRow);
                }
            });
    ...
    $('.btSimpan').on('click', function () {
        if($("#form_input #id_instansi").val().trim() === "") {
    ...
    var delInstansi = function (dataForm) {
        params = {
            option: 'ACTION',
            action: 'delInstansi',
            data: dataForm
