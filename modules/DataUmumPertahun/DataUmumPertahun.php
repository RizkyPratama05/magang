...
class DataUmumPertahun extends Database
{
    ...
    private function findField() {
        $findField = [
            "id_data_per_instansi","tahun","l","p","user_input","user_update","tgl_input","tgl_update"
        ];
        return $findField;
    }
    ...
    public function ACTION_list($return=false)
    {
        ...
        $sql = 'SELECT * FROM data_gender_umum';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM data_gender_umum ";
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into data_gender_umum (id_data_per_instansi,tahun,l,p,user_input,user_update,tgl_input,tgl_update) VALUES 
                                          (:id_data_per_instansi,:tahun,:l,:p,:user_input,:user_update,:tgl_input,:tgl_update)";
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update data_gender_umum set id_data_per_instansi=:id_data_per_instansi,tahun=:tahun,l=:l,p=:p,user_input=:user_input,user_update=:user_update,tgl_input=:tgl_input,tgl_update=:tgl_update
                 WHERE id_data_gender=:id_data_gender";
        echo $this->dbDataExecute($sql,$params['data']);
    }

    public function ACTION_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from data_gender_umum WHERE id_data_gender=:id_data_gender";
        echo $this->dbDataExecute($sql,$params['data']);
    }
