        ...
        MyApp.ajax(params).done(function (resp) {
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function (tpl) {
                    ...
                    data2 =[];
                    for (i=0;i<resp.result.length;i++){
                        data2[i]={};data2[i].kode_kategori = nama=resp.result[i].kode_kategori;data2[i].kode_aspek = nama=resp.result[i].kode_aspek;data2[i].aspek = nama=resp.result[i].aspek;
                    }
