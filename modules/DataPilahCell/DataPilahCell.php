...
class DataPilahCell extends Database
{
    ...
    private function findField() {
        $findField = [
            "tahun","kode_data_pilah","kode_kolom","kode_baris","val"
        ];
        return $findField;
    }
    ...
    public function ACTION_getKodePilah(){
        ...
        $sql = "select * from data_pilah order by kode_data_pilah asc";
    ...
    public function ACTION_getKodeBaris(){
        $params = isset($_GET) ? $_GET : $_POST;
        $kodeDataPilah = $params['kode_data_pilah'];
        $sql = "select * from data_pilah_baris where kode_data_pilah=$kodeDataPilah";
        echo $this->dbDataSelectAndReturnAll($sql);
    }
    ...
    public function ACTION_list($return=false)
    {
        ...
        $sql = 'SELECT * FROM data_pilah_cell';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM data_pilah_cell";
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "INSERT INTO `data_pilah_cell`(`id_data_pilah_cell`, `tahun`, `kode_data_pilah`, `kode_kolom`, `kode_baris`, `val`)
        VALUES (NULL,:tahun,:kode_data_pilah,:kode_kolom,:kode_baris,:val)";
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update data_pilah_cell set tahun=:tahun,kode_data_pilah=:kode_data_pilah, kode_kolom=:kode_kolom, kode_baris=:kode_baris, val=:val
        WHERE id_data_pilah_cell=:id_data_pilah_cell";
    ...
    public function ACTION_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from data_pilah_cell WHERE id_data_pilah_cell=:id_data_pilah_cell";
        echo $this->dbDataExecute($sql,$params['data']);
    }
