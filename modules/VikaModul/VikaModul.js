...
(function () {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [
            ...
            {"data": "id"},{"data": "nama"},{"data": "alamat"},{"data": "jenis_kelamin"},
        ],
        dom: 'Bfrtip',
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function (tpl) {
                    ...
                    for (i=0;i<resp.result.length;i++){
                        data2[i]={};data2[i].id = nama=resp.result[i].id;data2[i].nama = nama=resp.result[i].nama;data2[i].alamat = nama=resp.result[i].alamat;data2[i].jenis_kelamin = nama=resp.result[i].jenis_kelamin;
                    }
