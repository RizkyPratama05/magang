...
(function () {
    ...
    MyApp.$me.selectorTable2 = $('#datatable_fixed_column2').DataTable({
        ...
        "columns": [
            ...
            {"data": "id_data_gender"},{"data": "id_data_per_instansi"},{"data": "tahun"},{"data": "l"},{"data": "p"},{"data": "user_input"},{"data": "user_update"},{"data": "tgl_input"},{"data": "tgl_update"},
        ],
        dom: 'Bfrtip',
        ...
        initComplete: function () {
            ...
            button = '<button data-aksi="refresh" style="margin: 5px 5px 0 0" class="btn btn-danger btTop">' +
                ...
                '</button>'
            ;
            $('#datatable_fixed_column2_filter').append(button);
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function (tpl) {
                    ...
                    for (i=0;i<resp.result.length;i++){
                        data2[i]={};data2[i].id_data_gender = nama=resp.result[i].id_data_gender;data2[i].id_data_per_instansi = nama=resp.result[i].id_data_per_instansi;data2[i].tahun = nama=resp.result[i].tahun;data2[i].l = nama=resp.result[i].l;data2[i].p = nama=resp.result[i].p;data2[i].user_input = nama=resp.result[i].user_input;data2[i].user_update = nama=resp.result[i].user_update;data2[i].tgl_input = nama=resp.result[i].tgl_input;data2[i].tgl_update = nama=resp.result[i].tgl_update;
                    }
