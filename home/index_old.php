...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!-- sidebar menu: : style can be found in sidebar.less -->
                <ul class="sidebar-menu menu-utama" data-widget="tree">
                    <li class="header">MENU</li>
                    {{#menu}}
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-share"></i>
                            <span>{{judul_data_pilah}}</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a href="#">
                                    <i class="fa fa-circle-o"></i> {{nama_baris}}
                                    <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                                </a>
                                <ul class="treeview-menu">
                                    ...
                                    <li class="treeview">
                                        ...
                                        <ul class="treeview-menu">
                                            {{#child2}}
                                            <li class="treeview">
                                                <a href="#"><i class="fa fa-circle-o"></i> {{nama_baris}}</a>
                                                <ul class="treeview-menu">
                                                    {{#child3}}
                                                    <li><a href="#"><i class="fa fa-circle-o"></i> {{nama_baris}}</a></li>
                                                    {{/child3}}
                                                </ul>
                                            </li>
                                            {{/child2}}
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2019 <a href="#">Sleman</a>.</strong> All rights
        reserved.
    </footer>
