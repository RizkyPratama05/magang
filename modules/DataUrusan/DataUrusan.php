...
class DataUrusan extends Database
{
    ...
    public function ACTION_list($return=false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM tr_urusan ";
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into tr_urusan (kode_urusan,urusan,satuan) VALUES 
                                          (:kode_urusan,:urusan,:satuan)";
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update tr_urusan set kode_urusan=:kode_urusan,urusan=:urusan,satuan=:satuan
    ...
    public function ACTION_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from tr_urusan WHERE id_urusan=:id_urusan";
        echo $this->dbDataExecute($sql,$params['data']);
    }
