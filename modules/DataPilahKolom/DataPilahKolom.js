...
(function () {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [
            ...
            {"data": "kode_data_pilah"},{"data": "header_kolom"},{"data": "nama_kolom"},{"data": "kode_kolom"},{"data": "jml_l"},{"data": "jml_p"},{"data": "jml_lp"},{"data": "tipe_kolom"},{"data": "aktif"}
        ],
        dom: 'Bfrtip',
        ...
        initComplete: function () {
            ...
            $('.btTop').click(function () {
                ...
                if(aksi === 'add'){
                    ...
                    $('.modal-title').html("Tambah Data Pilah Kolom");
            ...
            selectortable.on('click','.btUpdate',function () {
                ...
                $('.modal-title').html("Update Data Pilah Kolom");
                kodePilah=dataRow.kode_data_pilah;
                $(".pilihKode").select2("val", dataRow.kode_data_pilah);
                dataRow = MyApp.$me.dataRow[index];
    ...
    $('.btSimpan').on('click', function () {
        if(pilihKode.val()=="") {
            alert("Kode data pilah harus diisi !")
        }else if($("#form_input #kode_kolom").val().trim() === "") {
            alert("Kode kolom harus diisi !")
        }else{
            idForm = $('#form_input');
