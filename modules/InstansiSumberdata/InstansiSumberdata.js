    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                width: '8%'
            },{"data": "kode_sumberdata"},{"data": "sumberdata"},
        ],
        dom: 'Bfrtip',
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function (tpl) {
                    ...
                    for (i=0;i<resp.result.length;i++){
                        data2[i]={};data2[i].id = nama=resp.result[i].id;data2[i].kode_instansi = nama=resp.result[i].kode_instansi;data2[i].kode_sumberdata = nama=resp.result[i].kode_sumberdata;
                    }
