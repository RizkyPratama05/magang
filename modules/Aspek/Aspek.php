...
class Aspek extends Database
{
    ...
    public function ACTION_list($return=false)
    {
        ...
        $sql = 'SELECT ref_aspek.*,ref_kategori.kategori FROM ref_aspek 
                INNER JOIN ref_kategori on ref_kategori.kode_kategori=ref_aspek.kode_kategori';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM ref_aspek ";
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into ref_aspek (kode_aspek,aspek) VALUES 
                                          (:kode_aspek,:aspek)";
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update ref_aspek set kode_aspek=:kode_aspek,aspek=:aspek
    ...
    public function ACTION_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from ref_aspek WHERE kode_kategori=:kode_kategori";
        echo $this->dbDataExecute($sql,$params['data']);
    }
