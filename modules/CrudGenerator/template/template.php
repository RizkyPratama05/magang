...
class namamodulclass extends Database
{
    ...
    public function ACTION_list($return=false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM namatabel ";
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into namatabel (tablefield) VALUES 
                                          (addFieldValue)";
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update namatabel set setUpdate
                 WHERE whereKondisi";
        echo $this->dbDataExecute($sql,$params['data']);
    }
    ...
    public function ACTION_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from namatabel WHERE whereKondisi";
        echo $this->dbDataExecute($sql,$params['data']);
    }
