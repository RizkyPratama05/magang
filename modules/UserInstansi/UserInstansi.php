...
//        echo $sql;exit();
    ...
    public function ACTION_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $kode_ins = $params['data']['id_instansi'];
        $sql_k = "SELECT * FROM reff_unit_kerja WHERE id_instansi=$kode_ins";
        $sql = "insert into reff_unit_kerja (id,id_instansi,nama_instansi) VALUES 
                                          (NULL,:id_instansi,:nama_instansi)";
        if($this->dbDataRowsCount($sql_k,$params['data']) > 0) {
            echo '{"success" : false,"msg": "Kode Instansi Sudah Ada"}';
        }else {
    ...
    public function ACTION_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_unit_kerja set id_instansi=:id_instansi,nama_instansi=:nama_instansi
                 WHERE id=:id";
        echo $this->dbDataExecute($sql,$params['data']);
    }
    ...
    public function ACTION_delInstansi(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_unit_kerja 
                 WHERE id_instansi=:id_instansi";
        echo $this->dbDataExecute($sql,$params['data']);
    }
